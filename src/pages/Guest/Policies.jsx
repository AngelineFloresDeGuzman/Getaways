  ...
  const policySections = [
    {
      ...
      description: 'Learn about cancellation rules and refund policies'
    },
    {
      id: 'terms',
    ...
    },
    {
      ...
      description: 'Rules and responsibilities for guests'
    },
    {
      id: 'refund',
      title: 'Refund Policy',
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Review Getaways policies, rules, and guidelines for guests
            </p>
          </div>
