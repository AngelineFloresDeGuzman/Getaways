...
const DropdownMenuSubTrigger = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(DropdownMenuPrimitive.SubTrigger, Object.assign({ ref: ref, className: cn("flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none data-[state=open]:bg-accent focus:bg-accent", inset && "pl-8", className) }, props),
        children,
