...
const FormControl = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(Slot, Object.assign({ ref: ref, id: formItemId, "aria-describedby": !error ? `${formDescriptionId}` : `${formDescriptionId} ${formMessageId}`, "aria-invalid": !!error }, props)));
});
