...
const HostTypeModal = ({ isOpen, onClose, currentUser }) => {
  ...
  const handleContinueAsHost = async () => {
    // Show host type selection after welcome screen
    setShowWelcomeScreen(false);
    setShowHostTypeSelection(true);
  ...
  const handleCloseLoginModal = () => {
    setShowLoginModal(false);
    setUseAnotherAccount(false);
    setShowWelcomeScreen(!!currentUser);
    setShowHostTypeSelection(!currentUser);
  };
        ...
        {showHostTypeSelection && (
          <div className="pt-16 pb-12 px-16">
            ...
            <div className="grid grid-cols-3 gap-8">
              ...
              <button
                onClick={() => {
                  setSelectedHostType('experience');
        ...
        {currentUser && showWelcomeScreen && !useAnotherAccount && (
          <div className="pt-16 pb-12 px-16 text-center">
            ...
            <button
              ...
              className="w-full bg-primary text-white py-4 px-6 rounded-xl font-medium text-lg hover:from-rose-600 hover:to-pink-600 transition-all mb-4"
            >
              Continue as Host
            </button>
